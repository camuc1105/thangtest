		...
		<div class="row">
				...
				<div class="sidebar-sticky">
					<ul class="nav flex-column">
						...
						<li class="nav-item ml-4"><a class="nav-link"
							href="dangkysudungmay"> <span data-feather="file-plus"></span>
								Thêm thông tin
						</a></li>
					</ul>
				</div>
			...
			<div class="col-md-10 px-4 content">
				<div
					...
					<h1 class="h2">Danh sách sử dụng máy</h1>
				</div>
				...
				<div class="table-container">
					...
					<table class="table table-striped">
						...
						<tbody>
							<c:forEach items="${danhsachsudungmay}" var="suDungMay">
								<tr>
									<td>${suDungMay.khachhang.makh}</td>
									<td>${suDungMay.may.mamay}</td>
									<td>${suDungMay.ngaysudung}</td>
									<td>${suDungMay.giosudung}</td>
