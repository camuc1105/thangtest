			...
			<div class="box">
				...
				<div class="login-box">
					<h3 class="text-center">Tạo dịch vụ mới</h3>
					 <form:form id="dichvuForm" action="${pageContext.request.contextPath}/luuDichVu" method="post" style="width: 300px" modelAttribute="dichVu">
                        <div class="form-group">
                            <label for="madv" class="sr-only">Mã dịch vụ</label>
                            <div class="input-group">
                                <form:input path="madv" id="madv" class="form-control" placeholder="Mã dịch vụ" />
                            </div>
                                <form:errors path="madv" class="text-danger"/>
                                 <div id="madv-error" class="error"></div>
                        </div>
                        <div class="form-group">
                            <label for="tendv" class="sr-only">Tên dịch vụ</label>
                            <div class="input-group">
                                <form:input path="tendv" id="tendv" class="form-control" placeholder="Tên dịch vụ" />
                            </div>
                                <form:errors path="tendv" class="text-danger"/>
                                <div id="tendv-error" class="error"></div>
                        </div>
                        <div class="form-group">
                            <label for="donvitinh" class="sr-only">Đơn vị tính</label>
                            <div class="input-group">
                                <form:input path="donvitinh" id="donvitinh" class="form-control" placeholder="Đơn vị tính" />
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <form:input path="dongia" id="dongia" type="number" value="0" class="form-control" placeholder="Đơn giá" />
                            </div>
