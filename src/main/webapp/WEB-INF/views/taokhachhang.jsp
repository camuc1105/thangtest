		...
		<div class="bg-secondary mt-5 p-3">
			<div class="box">
				...
				<div class="login-box">
				 ...
				 <form:form id="khachHangForm" action="${pageContext.request.contextPath}/luuKhachHang" method="post" style="width: 300px" modelAttribute="khachHang">
                        <div class="form-group">
                            <label for="makh" class="sr-only">Mã KH</label>
                            <div class="input-group">
                                <form:input path="makh" id="makh" class="form-control" placeholder="Mã KH (KHxxxxx)" />
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <form:input path="tenkh" id="tenkh" class="form-control" placeholder="Tên khách hàng" />
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <form:input path="diachi" id="diachi" class="form-control" placeholder="Địa chỉ" />
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <form:input path="sdt" id="sdt" class="form-control" placeholder="Số điện thoại" />
                            </div>
